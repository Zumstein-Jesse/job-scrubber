...
if __name__ == "__main__":
    ...
    # File paths
    all_jobs_file = os.path.join(desktop, 'Jobs.txt')
    new_jobs_file = os.path.join(desktop, 'JobsNew.txt')
    ...
    write_jobs_to_file(all_jobs_file, current_jobs, "Current Jobs")

    # Write only new jobs to JobsNew.txt
    write_jobs_to_file(new_jobs_file, new_jobs, "New Jobs")